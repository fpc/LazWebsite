...
//--- versions ---
$dl_latest_version_lazarus = '4.2';
$dl_latest_version_dir= '4.2';  // could be 1.2, for version 1.2.0
...
$wiki_changes = 'https://wiki.lazarus.freepascal.org/Lazarus_4.0_fixes_branch';
